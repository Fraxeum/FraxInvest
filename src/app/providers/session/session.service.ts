  ...
  /*
    public async updateUserdata(type: string, name: string, value: string): Promise<any> {
      return await new Promise((resolve, reject) => {
        ...
        this.getUserdata().then(async (data) => {
          ...
          Storage.set("currentUser", this.userdata).then(() => {
            resolve(true);
          });
        });
    ...
    public async getUserdata(): Promise<any> {
      return await new Promise((resolve, reject) => {
        ...
        Storage.get("currentUser").then((result) => {
          resolve(result);
        });
      });
    }
    ...
    public async updateBalances(balances): Promise<any> {
      ...
      this.getUserdata().then((userdata) => {
        ...
        return new Promise((resolve, reject) => {
          ...
          Storage.set("currentUser", userdata).then(async (result) => {
            await result;
  ...
  */
  ...
  public getToken(): Promise<any> {
    ...
    return new Promise((resolve, reject) => {
      ...
      return Storage.get({ key: "session_token" }).then((value) => {
