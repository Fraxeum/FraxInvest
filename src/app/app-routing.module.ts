...
const routes: Routes = [
  ...
  {
    path: 'investment-detail-two',
    loadChildren: () => import('./investment-detail-two/investment-detail-two.module').then(m => m.InvestmentDetailTwoPageModule)
  },
  {
    path: 'azuza-help',
    loadChildren: () => import('./azuza-help/azuza-help.module').then(m => m.AzuzaHelpPageModule)
  },
  {
    path: 'home',
    loadChildren: () => import('./home/home.module').then(m => m.HomePageModule)
