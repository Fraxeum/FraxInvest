...
export class InvestmentDetailOnePage implements OnInit {
  ...
  slides = [
    { poster: 'assets/img/client-1/video-splash/infinite-1.png', url: 'https://www.youtube.com/embed/2u_xRff5dms' },
    { poster: 'assets/img/client-1/video-splash/infinite-2.png', url: 'https://www.youtube.com/embed/tXi9SmWaX3g' },
    { poster: 'assets/img/client-1/video-splash/infinite-7.png', url: 'https://www.youtube.com/embed/-CjrNsfCS0E' },
    { poster: 'assets/img/client-1/video-splash/infinite-6.png', url: 'https://www.youtube.com/embed/baXJQqEhxxE' },
    { poster: 'assets/img/client-1/video-splash/infinite-3.png', url: 'https://www.youtube.com/embed/TTa8I1mZSWw' },
    { poster: 'assets/img/client-1/video-splash/infinite-4.png', url: 'https://www.youtube.com/embed/O0QSAkUrprw' },
    { poster: 'assets/img/client-1/video-splash/infinite-8.png', url: 'https://www.youtube.com/embed/7kbdk5X7q0I' },
    { poster: 'assets/img/client-1/video-splash/infinite-5.png', url: 'https://www.youtube.com/embed/brvfPQE3mMw' }
  ];
  ...
  async primeObjects() {
    ...
    this.accordionData = [
      ...
      },
      {
        ...
        description: "This company has Soft Raise Target. That means you buy shares using the cash that you deposited into your Azuza wallet and the shares are transferred to your wallet within 5 business days of your purchase.",
        active: false
      },
      {
        title: 'What if the target is not reached?',
        description: "Soft Raise Targets do not require the raise target to be met. The rasie target represents the upper limit of shares to be sold in this investment round.",
        active: false
      },
      {
        title: 'What if the due dilligence fails?',
        description: "Infinite Industries has already passed an indepth due diligence carried out by the investment committee of Instavest Capital.",
        active: false
      },
      {
  ...
  setProductImages() {
    this.productImages = [
      ...
      },
      {
        ...
        name: 'Product 3',
        description: 'Compressed plastic'
      },
      {
        src: 'assets/img/client-1/product/4.png',
        name: 'Product 4',
        description: 'School workstation'
      },
      {
  ...
  launchDocs(id: number) {
    ...
    switch (id) {
      ...
      case 1: {
        // IM URL
        url = "https://www.iindustries.co.za";
        break;
      }
      case 2: {
        // IM URL
